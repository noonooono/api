-- 创建库
create database if not exists sonapi;
...
INSERT INTO `sonapi`.`user` (`id`, `userName`, `userAccount`, `userAvatar`, `gender`, `userRole`, `userPassword`,
                               `createTime`, `updateTime`, `isDelete`)
VALUES (1, 'dingding', 'son', 'https://avatars.githubusercontent.com/u/61930795?v=4', 0, 'admin',
